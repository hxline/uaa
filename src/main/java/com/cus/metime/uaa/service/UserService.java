...
//    private final AssyncMessagingService assyncMessagingService;
    ...
    public UserService(UserRepository userRepository, PasswordEncoder passwordEncoder, AuthorityRepository authorityRepository, UserToUserDTOAssembler userToUserDTOAssembler) {
